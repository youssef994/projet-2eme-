...
void Dialog::on_pushButton_clicked()
{
   ...
   if(c.verif_id(id)==false){
       ...
       QMessageBox::critical(nullptr,QObject::tr("ajouter employee"),
...
if (test)
    {
    ui->tableView->setModel(c.afficherperso());
    QMessageBox::information(nullptr,QObject::tr("ajouter employee"),
...
{   QSqlQuery qry ;
  ...
  if(R.verif_id(id_reservation)==false){
      ...
      QMessageBox::critical(nullptr,QObject::tr("ajouter conges"),
                                       QObject::tr("ID Doit contenir 6 chifres.\n"
                                                   "Click Cancel to exit ."),QMessageBox::Cancel);
           }else if((gp_music=="")){
      QMessageBox::critical(nullptr,QObject::tr("ajouter conges"),
...
if(test)
{
    QMessageBox::information(nullptr,QObject::tr("ajouter conges"),
                                         QObject::tr("conges ajoutee .\n"
                                                     "Click Cancel to exit ."),QMessageBox::Cancel);
         }
    else
    {
...
void Dialog::on_pushButton_modifierreservation_clicked()
{
 ...
 bool test=r.modifierreservation();
     if (test)
             {
         QMessageBox::information(nullptr,QObject::tr("modifier conges"),
                                          QObject::tr("conges modifie .\n"
                                                      "Click Cancel to exit ."),QMessageBox::Cancel);

              }
         else
         {
         QMessageBox::critical(nullptr,QObject::tr("modifier conges"),
                                          QObject::tr("conges modifie .\n"
                                                      "Click Cancel to exit ."),QMessageBox::Cancel);
            }
...
void Dialog::on_pushButton_3_clicked()
{
   ...
   Reservation r;
    ...
    if(test)
       {
        QMessageBox::information(nullptr,QObject::tr("suprimer conges"),
                                         QObject::tr("conges suprimer .\n"
                                                     "Click Cancel to exit ."),QMessageBox::Cancel);
